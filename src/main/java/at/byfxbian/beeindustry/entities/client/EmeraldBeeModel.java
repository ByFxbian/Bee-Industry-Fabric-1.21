...
public class EmeraldBeeModel extends EntityModel<CustomBeeEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        root.addChild("bb_main", ModelPartBuilder.create().uv(39, 0).cuboid(-1.0F, -5.0F, -7.0F, 3.0F, 4.0F, 2.0F), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
    ...
    public void setAngles(CustomBeeEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        ...
        if (!entity.hasAngerTime()) {
            ...
            if (!bl) {
                ...
                //this.bb_main.pitch = 0.F + k * (float) Math.PI * 0.025F;
                ...
                this.bb_main.pivotY = 23.5F - (MathHelper.cos(animationProgress * 0.18F) * 0.1F);
            }
        }
