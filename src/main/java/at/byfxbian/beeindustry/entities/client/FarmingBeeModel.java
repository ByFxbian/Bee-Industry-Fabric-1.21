...
public class FarmingBeeModel extends EntityModel<CustomBeeEntity> {
    ...
    public FarmingBeeModel(ModelPart root) {
        ...
        this.frontLegs = this.body.getChild("leg_front");
        this.middleLegs = this.body.getChild("leg_mid");
        this.backLegs = this.body.getChild("leg_back");
    }
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        // Hier definieren wir die "Knochen" und "Würfel" exakt so, wie sie in deiner farming_bee.geo.json stehen.
        ModelPartData body = root.addChild("body", ModelPartBuilder.create().uv(0, 0).cuboid(-3.5F, -4.0F, -5.0F, 7.0F, 7.0F, 10.0F)
                .uv(2, 0).cuboid(1.5F, -4.0F, -8.0F, 1.0F, 2.0F, 3.0F)
                .uv(2, 3).cuboid(-2.5F, -4.0F, -8.0F, 1.0F, 2.0F, 3.0F), ModelTransform.pivot(0.5F, 19.0F, 0.0F));

        body.addChild("stinger", ModelPartBuilder.create().uv(26, 7).cuboid(0.0F, 0.0F, 4.0F, 0.0F, 1.0F, 2.0F), ModelTransform.pivot(0.0F, -1.0F, 1.0F));

        body.addChild("rightwing_bone", ModelPartBuilder.create().uv(0, 18).cuboid(-9.0F, 0.0F, 0.0F, 9.0F, 0.0F, 6.0F), ModelTransform.of(-1.5F, -4.0F, -3.0F, 0.2618F, -0.2618F, 0.0F));

        body.addChild("leftwing_bone", ModelPartBuilder.create().uv(9, 24).cuboid(0.0F, 0.0F, 0.0F, 9.0F, 0.0F, 6.0F), ModelTransform.of(1.5F, -4.0F, -3.0F, 0.2618F, 0.2618F, 0.0F));

        body.addChild("leg_front", ModelPartBuilder.create().uv(26, 1).cuboid(-5.0F, 0.0F, 0.0F, 7.0F, 2.0F, 0.0F), ModelTransform.pivot(1.5F, 3.0F, -2.0F));

        body.addChild("leg_mid", ModelPartBuilder.create().uv(26, 3).cuboid(-5.0F, 0.0F, 0.0F, 7.0F, 2.0F, 0.0F), ModelTransform.pivot(1.5F, 3.0F, 0.0F));

        body.addChild("leg_back", ModelPartBuilder.create().uv(26, 5).cuboid(-5.0F, 0.0F, 0.0F, 7.0F, 2.0F, 0.0F), ModelTransform.pivot(1.5F, 3.0F, 2.0F));

        root.addChild("bb_main", ModelPartBuilder.create().uv(48, 1).cuboid(-1.0F, -12.0F, -5.0F, 3.0F, 3.0F, 3.0F)
                .uv(38, 7).cuboid(-4.0F, -9.0F, -7.0F, 9.0F, 0.0F, 8.0F), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
    ...
    public void setAngles(CustomBeeEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        ...
        if (!entity.hasAngerTime()) {
            ...
            if (!bl) {
                ...
                this.bb_main.pitch = 0.08F + k * (float) Math.PI * 0.025F;
                ...
                this.bb_main.pivotY = 24.0F - MathHelper.cos(animationProgress * 0.18F) * 0.9F;
            }
        }

        if (this.bodyPitch > 0.0F) {
            this.body.pitch = ModelUtil.interpolateAngle(this.body.pitch, 3.0915928F, this.bodyPitch);
            //this.bb_main.pitch = ModelUtil.interpolateAngle(this.bb_main.pitch, 3.0915928F, this.bodyPitch);
        }
    }
